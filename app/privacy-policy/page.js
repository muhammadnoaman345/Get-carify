export default function PrivacyPolicy() {
  return (
    <div className="pt-32 px-6 max-w-5xl mx-auto bg-gradient-to-b from-gray-900 to-black text-gray-300">
      ...
      <div className="space-y-8 leading-relaxed">
        <section>
          ...
          <p>
            Welcome to <span className="text-green-500 font-medium">The Vehicle Audit</span>, 
            ...
            (<a
              ...
              className="text-green-400 hover:text-green-500 underline ml-1"
            >
              https://thevehicleaudit.com
            </a>) 
            and the associated products, services, data, information, and materials
            offered therein (collectively, the "Services").
          </p>
        </section>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-2 text-white">Changes to the Policy</h2>
          <p>
            ...
            >
              Privacy Policy
            </a>. Any revision and/or addition to this Policy shall become
            effective and binding on you when you continue to use the Services
