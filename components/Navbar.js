  ...
  return (
    <header className="bg-black text-white py-4 px-8 flex justify-between items-center fixed top-0 left-0 w-full z-50 shadow-md">
      ...
      <a href="/" className="flex items-center">
        <img src="/logo.png" alt="The Vehicle Audit" className="h-12 md:h-16" />
      </a>
      ...
      {/* CTA Button */}
      <button className="hidden md:block bg-green-500 px-5 py-2 rounded-md font-semibold hover:bg-green-600">
        Get Your Report
      </button>
      ...
      {isOpen && (
        <div className="absolute top-16 left-0 w-full bg-black text-white flex flex-col items-center space-y-4 py-6 border-t border-gray-700 md:hidden">
          ...
          <button className="bg-green-500 px-6 py-2 rounded-md font-semibold hover:bg-green-600 w-4/5">
            Get Your Report
          </button>
        </div>
      )}
