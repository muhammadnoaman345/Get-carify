...
export default function CarDetails() {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('/car-bg.jpg')", // optional: put a bg image in public folder
        backgroundSize: "cover",
        backgroundPosition: "center",
      }}
    >
      <div className="backdrop-blur-sm bg-black/50 min-h-screen p-6 rounded-2xl">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Left side */}
          <div className="md:col-span-2 space-y-6">
            {/* Vehicle Details */}
            <div className="grid grid-cols-3 gap-4 bg-green-600/70 backdrop-blur-md text-black p-6 rounded-2xl font-bold text-lg shadow-lg">
              <div>
                <p>Make</p>
                <p>Manufacturer</p>
              </div>
            ...
            {/* Key Specifications */}
            <div className="bg-gray-900/50 backdrop-blur-md rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-6">
            <div className="bg-gray-900/80 rounded-2xl shadow-xl p-6">
              <Image
                src="/car-report.jpg"
                alt="Car Image"
                width={400}
              ...
              <button className="w-full bg-green-600 hover:bg-green-700 text-black font-bold py-3 px-4 rounded-2xl mt-4 transition">
