...
export default function Home() {
  ...
  const handleGetReport = () => {
    ...
    setError("");
    const query = searchType === "vin" ? `?vin=${inputValue}` : `?license=${inputValue}`;
  ...
  return (
    <>
      ...
      <section
        id="vin-section"
        className="relative flex items-center justify-center text-center text-white h-screen mt-32"
      >
        <Image
        ...
        <div className="relative z-10 px-4 max-w-3xl mx-auto">
          ...
          <div className="mt-10 flex flex-col items-center">
            ...
            <p className="mt-4 text-sm text-gray-400">
              Search by {searchType === "vin" ? "VIN" : "License Plate"} to get
              started.
            </p>
          </div>
        </div>
